...
class PtxCommand extends vscode.TreeItem {
    constructor(label, desc, cmdId, collapsibleState, iconNameNoExt, isCmdWithPreset) {
        ...
        this.isCmdWithPreset = isCmdWithPreset;
        this.iconPath = {
        ...
        this.contextValue = this.isCmdWithPreset;
    }
    getCmdId() {
        return this.cmdId;
    }
}
//# sourceMappingURL=ptxCommands%20copy.js.map